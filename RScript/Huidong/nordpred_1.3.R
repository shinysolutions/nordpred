...
## Version 1.3 ##
## Changes: 
##   1. Removed codes for S-PLUS;
##   2. 'anova.glm' is a non-visible function in R 3.1.1, which means
##      it can't be called directly. We can specify the package 
##      name to call it, like 'stat:::anova.glm', or we can just 
##      use 'anova' which will do 'anova.glm' analysis because we 
##      pass a 'glm' object to it. 
##   3. Add a 'Holford' version of drift function: contr.orth;




## Holford version of drift (Holford, 1983)
## http://www.filewatcher.com/p/r-cran-epi_1.1.24.orig.tar.gz.676834/Epi/R/contr.orth.R.html
contr.orth <- function(n, contrasts = TRUE, sparse = FALSE){
...
nordpred <- function(cases,pyr,startestage,startuseage,noperiods=NULL,recent=NULL,
  ...
  # Version 1.2. updated 2012-09-19 for compabilty with newer R versions 
...
#   # Setting contrast:
#   options(contrasts=c("contr.orth","contr.poly"))
